...
function createVideoTemplate(data) {
    ...
    content.innerHTML = '<p id="content-close">X</p><h3>Find Out More where to watch <a id=linkOut href = "https://www.themoviedb.org/movie/now-playing?language=en-US" style="font-size:30px;">Link</a></h3>';
...
document.onclick = function (event) {
    ...
    if (tagName.toLowerCase() === 'img') {
        ...
        getReviewsByMovieId(movieId, content);
